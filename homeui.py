...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(730, 50, 259, 30))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(730, 330, 236, 80))
        self.gridLayoutWidget_3.setObjectName("gridLayoutWidget_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.gridLayoutWidget_3)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.checkBox_led = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.checkBox_led.setObjectName("checkBox_led")
        self.gridLayout_3.addWidget(self.checkBox_led, 0, 1, 1, 1)
        self.checkBox_sti = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.checkBox_sti.setObjectName("checkBox_sti")
        self.gridLayout_3.addWidget(self.checkBox_sti, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_led.setText(_translate("MainWindow", "LED Light Source"))
        self.checkBox_sti.setText(_translate("MainWindow", "Projector"))
